...
def plot_graph(Path_graph, Path_plot):
    ...
    for node in graph.nodes():
        ...
        for edge in graph.edges():
            if edge_class[edge] in ["Signal line", "Process connection line"]:
                ...
                edge_class[edge] == "Piping"
                and edge_sub_class[edge] == "Secondary pipe"
            ):
                width.append(1)
    ...
    plot_graph = plt.figure(
        figsize=(15, 10)
    )  # leeres Bild erzeugt, worauf gleich gezeichnet wird
...
def plot_graph2(Path_graph, Path_plot):
    ...
    for node in graph.nodes():
        ...
        pos[node] = (
            float(graph.nodes[node]["node_x"]),
            float(graph.nodes[node]["node_y"]),
        )
